...
# Definimos la funcion principal donde se alojarà todo el juego
def juego_trivia():
    ...
    def validar_edad(edad):
        ...
        if edad >= edad_minima:
            ...
            print(
                "Esperamos que aprendas y también te diviertas al responder estas preguntas de Programación.")
            print("El juego funcionará de la siguiente manera: te presentaremos una serie de preguntas que retarán tus conocimientos de Programación en Python.")
            print(
    ...
    # Función que contiene la verificacion de respuestas
    ...
    #     print(
    #         "\x1b[1m¡Muchas gracias por haber participado en este juego, esperamos verte de nuevo!\x1b[0m")
